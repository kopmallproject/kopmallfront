...
import MainAdminLayout from '@/app/(routes)/admin/components/layout/MainAdminLayout';
...
function OrderDetails() {
  return (
    <MainAdminLayout>
      ...
      <main className="bg-white rounded-[7px] pb-[100px] w-full flex flex-col h-full text-[14px]">
        <div className="w-full flex items-center gap-2">
          <HiArrowLongLeft className="hidden h-8 w-8" />
          <h2 className="poppins font-medium text-[16px] pb-1">
            Order Details
          </h2>
        </div>
        ...
        <div className="section-two">
          ...
          <div className="lg:mt-0 w-full grid lg:grid-cols-2 gap-3 text-[14px]">
