...
function ClosedOrders() {
  return (
    <>
      <main className="w-full grid lg:grid-cols-2 min-h-[150px] text-[14px] gap-4">
          ...
          <div className="w-full border-[1px] rounded-[7px] gap-3 flex flex-col sm:flex-row sm:justify-between sm:items-start p-2 xm:px-4">
            <div className="w-full flex items-center gap-5">
              ...
              <div className="w-full flex flex-col text-[12px]">
                ...
                <div className="text-xs mb-1.5 text-white bg-red-600 px-3 self-start py-1 rounded-[7px]">
                  Closed
                </div>
