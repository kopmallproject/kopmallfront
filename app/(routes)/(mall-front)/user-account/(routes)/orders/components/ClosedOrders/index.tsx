...
function ClosedOrders() {
  return (
    <>
      <main className="w-full  flex flex-col min-h-[150px] text-[14px]">
        ...
        <div className="mt-3 lg:mt-0 py-3 w-full flex flex-col gap-4">
          <div className="w-full border gap-3 flex flex-col sm:flex-row sm:justify-between sm:items-start p-4">
            <div className="w-full flex items-center gap-3">
              ...
              <div className="w-full flex flex-col gap-3">
                ...
                <span className="text-xs capitalize block w-20 text-white bg-slate-600 p-1 rounded-sm">
                  refunded
                </span>
          ...
          <div className="w-full border gap-3 flex flex-col sm:flex-row sm:justify-between sm:items-start p-4">
            <div className="w-full flex items-center gap-3">
              ...
              <div className="w-full flex flex-col gap-3">
                ...
                <span className="block text-slate-400">Order 217892</span>
                <span className="text-xs block w-20 text-white bg-slate-600 p-1 rounded-sm">
                  Delivered
                </span>
                <span className="poppins block">On 21-06-2024</span>
              </div>
